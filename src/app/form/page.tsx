          ...
          <div className="fade-up" style={{ animationDelay: '0.1s' }}>
            ...
            {([ 
              ...
              <div key={field.name} style={{ marginBottom: 28 }}>
                <label className="condensed" style={{
                  display: 'block',
                  fontSize: '0.68rem',
                  letterSpacing: '0.25em',
                  textTransform: 'uppercase',
                  color: fieldErrors[field.name] ? 'rgba(220,38,38,.8)' : '#c9a84c',
                  marginBottom: 10,
                }}>
                  {field.label}
                </label>
                ...
                {fieldErrors[field.name] && (
                  <p className="body-font" style={{ fontSize: '0.72rem', color: 'rgba(220,38,38,.8)', marginTop: 6 }}>
                    {fieldErrors[field.name]}
                  </p>
                )}
              </div>
            ...
            <div style={{ marginBottom: 36 }}>
              <label className="condensed" style={{
                ...
                letterSpacing: '0.25em',
                textTransform: 'uppercase',
                color: fieldErrors.endereco ? 'rgba(220,38,38,.8)' : '#c9a84c',
                marginBottom: 10,
              }}>
                Endereço de Entrega
              </label>
          ...
          >
            ...
            <div style={{ position: 'relative', width: '100%', aspectRatio: '1/1', background: '#0a0a0a' }}>
              ...
              <div style={{
                ...
                background: 'linear-gradient(transparent, rgba(13,13,8,.98))',
                pointerEvents: 'none',
              }} />
              {/* Tag */}
              {camisa.tag && (
            ...
            <div style={{ padding: '22px 24px 26px' }}>
              <div className="condensed" style={{ fontSize: '0.62rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: 'rgba(240,234,214,.3)', marginBottom: 8 }}>
                Seu Pedido
              </div>
              <h2 style={{ fontSize: '1.5rem', letterSpacing: '0.03em', marginBottom: 4, lineHeight: 1 }}>{camisa.nome}</h2>
              {camisa.cores && (
                <div className="condensed" style={{ fontSize: '0.68rem', letterSpacing: '0.18em', color: '#c9a84c', textTransform: 'uppercase', marginBottom: 12 }}>{camisa.cores}</div>
              )}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <button
                  ...
                  style={{
                    padding: '8px 16px',
                    background: 'transparent',
                    border: '1px solid rgba(180,140,30,.2)',
                    borderRadius: 3,
